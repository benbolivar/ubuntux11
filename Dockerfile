...
RUN apt-get update && apt-get install -y software-properties-common libxext-dev libxrender-dev libxtst-dev && apt-get -y autoremove libgtk2.0-0 libcanberra-gtk-module g++ libboost-all-dev build-essential gdb cmake
